...
#line 89 "smt.tab.cpp" /* yacc.c:339  */
...
union YYSTYPE
{
#line 21 "smt.ypp" /* yacc.c:355  */

    unsigned int ival;
    class Formula_input *f;

#line 150 "smt.tab.cpp" /* yacc.c:355  */
};
...
#line 165 "smt.tab.cpp" /* yacc.c:358  */
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 47 "smt.ypp" /* yacc.c:1646  */
    { res_smt = (yyvsp[0].f); }
#line 1252 "smt.tab.cpp" /* yacc.c:1646  */
    break;

  case 3:
#line 51 "smt.ypp" /* yacc.c:1646  */
    { (yyval.f) = (yyvsp[-1].f); }
#line 1258 "smt.tab.cpp" /* yacc.c:1646  */
    break;

  case 4:
#line 55 "smt.ypp" /* yacc.c:1646  */
    { (yyval.f) = new FVar_input((yyvsp[-2].ival),(yyvsp[0].ival),true); }
#line 1264 "smt.tab.cpp" /* yacc.c:1646  */
    break;

  case 5:
#line 56 "smt.ypp" /* yacc.c:1646  */
    { (yyval.f) = new FVar_input((yyvsp[-2].ival),(yyvsp[0].ival),false); }
#line 1270 "smt.tab.cpp" /* yacc.c:1646  */
    break;

  case 6:
#line 57 "smt.ypp" /* yacc.c:1646  */
    { (yyval.f) = (yyvsp[-1].f); }
#line 1276 "smt.tab.cpp" /* yacc.c:1646  */
    break;

  case 7:
#line 58 "smt.ypp" /* yacc.c:1646  */
    { (yyval.f) = new FOperation_input((yyvsp[-2].f), (yyvsp[0].f), FOperation_input::AND); }
#line 1282 "smt.tab.cpp" /* yacc.c:1646  */
    break;

  case 8:
#line 59 "smt.ypp" /* yacc.c:1646  */
    { (yyval.f) = new FOperation_input((yyvsp[-2].f), (yyvsp[0].f), FOperation_input::AND); }
#line 1288 "smt.tab.cpp" /* yacc.c:1646  */
    break;

  case 9:
#line 60 "smt.ypp" /* yacc.c:1646  */
    { (yyval.f) = new FOperation_input((yyvsp[-2].f), (yyvsp[0].f), FOperation_input::OR); }
#line 1294 "smt.tab.cpp" /* yacc.c:1646  */
    break;

  case 10:
#line 61 "smt.ypp" /* yacc.c:1646  */
    { (yyval.f) = new FOperation_input((yyvsp[-2].f), (yyvsp[0].f), FOperation_input::XOR); }
#line 1300 "smt.tab.cpp" /* yacc.c:1646  */
    break;

  case 11:
#line 62 "smt.ypp" /* yacc.c:1646  */
    { (yyval.f) = new FOperation_input((yyvsp[-2].f), (yyvsp[0].f), FOperation_input::IMPLY); }
#line 1306 "smt.tab.cpp" /* yacc.c:1646  */
    break;

  case 12:
#line 63 "smt.ypp" /* yacc.c:1646  */
    { (yyval.f) = new FOperation_input((yyvsp[-2].f), (yyvsp[0].f), FOperation_input::EQUIV); }
#line 1312 "smt.tab.cpp" /* yacc.c:1646  */
    break;

  case 13:
#line 64 "smt.ypp" /* yacc.c:1646  */
    { (yyval.f) = new FOperation_input((yyvsp[0].f), NULL, FOperation_input::NEGATE); }
#line 1318 "smt.tab.cpp" /* yacc.c:1646  */
    break;


#line 1322 "smt.tab.cpp" /* yacc.c:1646  */
      default: break;
    }
